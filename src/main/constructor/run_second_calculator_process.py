...
def run_second_calculator_process() -> None:
    ...
    if result['success']: run_second_calculator_view.run_second_calculator_success (result)
    else: run_second_calculator_view.run_second_calculator_fail(result["error"])
